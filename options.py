...
def read():
    ...
    parser.add_argument(
        "--q-out-vocab", default=3, type=int, help="Output vocabulary for questioner"
    )
    parser.add_argument(
        "--a-out-vocab", default=4, type=int, help="Output vocabulary for answerer"
    )
    parser.add_argument(
        "--img-feat-size",
        default=20,
    ...
    parser.add_argument(
        "--embed-size", default=20, type=int, help="Embed size for words"
    )
    parser.add_argument(
        "--hidden-size",
        default=100,
    ...
    parser.add_argument(
        "--rl-scale", default=100.0, type=float, help="Weight given to rl gradients"
    )
    parser.add_argument(
        "--num-rounds", default=2, type=int, help="Number of rounds between Q and A"
    )
    parser.add_argument(
        "--memoryless-abot",
        dest="memoryless_abot",
        action="store_true",
    ...
    parser.add_argument(
        "--batch-size", default=1000, type=int, help="Batch size during training"
    )
    parser.add_argument(
        "--num-epochs", default=1000000, type=int, help="Max number of epochs to run"
    )
    parser.add_argument(
